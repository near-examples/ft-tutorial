...
You'll learn more about these functions in the [circulating supply](3-circulating-supply.md) and [transfers](5.transfers.md) sections of the tutorial series.
...
Using `yarn`, you've been able to compile the contract, and you'll start fleshing out this skeleton in the next [section](3-circulating-supply.md) of the tutorial.
