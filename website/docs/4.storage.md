...
description: "Learn to register accounts in a NEAR FT contract using the storage management standard safely."
---
...
<img width="65%" src="/ft-tutorial/assets/docs/tutorials/fts/storage-standard-meme.png" />
